          ...
          <div className="relative max-w-lg">
            <label>
              ...
              <input
                ...
                className="focus:border-primary-500 focus:ring-primary-500 dark:text-white-400 block w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-900 dark:border-gray-900 dark:bg-gray-800"
              />
            </label>
            <svg
